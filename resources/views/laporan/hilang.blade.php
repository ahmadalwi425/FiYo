...
<section id="appointment" class="appointment section-bg" style="padding-top:150px">
      <div class="container" data-aos="fade-up">
        ...
        <form action="{{url('laporan/hilang')}}" enctype="multipart/form-data" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
          @csrf
          <div class="form-row">
            ...
            <div class="col-md-4 form-group">
            <label for="hilang">Tanggal Kehilangan</label>
          ...
          <div class="form-row">
            <div class="col-md-6 form-group">
              ...
              <input type="text" name="lokasi" class="form-control" id="lokasi" placeholder="Lokasi Anda Kehilangan Barang" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
            <div class="col-md-6 form-group">
            <label for="foto">Foto Barang Hilang (jika tidak ada bisa menggunakan foto wajah)</label>
              <input type="file" class="form-control" name="foto" id="foto" placeholder="Tanggal Hilang" >
              <div class="validate"></div>
            </div>
          </div>
