...
<body>
  ...
  <header id="header" class="header-transparent">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="index.html" class="scrollto">Find Yours</a></h1>
        <!-- Uncomment below if you prefer to use an image logo -->
        <!-- <a href="index.html"><img src="{{asset('assets1/img/logo.png')}}" alt=""></a> -->
      </div>
  ...
  <section id="intro">
    ...
    <div class="product-screens">
      ...
      <div class="product-screen-1 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.6s">
        <img src="{{asset('assets1/img/product-screen-1.png')}}" alt="">
      </div>

      <div class="product-screen-2 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.6s">
        <img src="{{asset('assets1/img/product-screen-2.png')}}" alt="">
      </div>

      <div class="product-screen-3 wow fadeInUp" data-wow-duration="0.6s">
        <img src="{{asset('assets1/img/product-screen-3.png')}}" alt="">
      </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-6 about-img wow fadeInLeft">
            <img src="{{asset('assets1/img/about-img.jpg')}}" alt="">
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 features-img">
            <img src="{{asset('assets1/img/product-features.png')}}" alt="" class="wow fadeInLeft">
          </div>
    ...
    <section id="advanced-features">
      ...
      <div class="features-row section-bg">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right wow fadeInRight" src="{{asset('assets1/img/advanced-feature-1.jpg')}}" alt="">
      ...
      <div class="features-row">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-left" src="{{asset('assets1/img/advanced-feature-2.jpg')}}" alt="">
      ...
      <div class="features-row section-bg">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right wow fadeInRight" src="{{asset('assets1/img/advanced-feature-3.jpg')}}" alt="">
              <div class="wow fadeInLeft">
                <h2>Duis aute irure dolor in reprehenderit in voluptate velit esse</h2>
                <h3>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
      ...
      <div class="container">
        ...
        <div class="row wow fadeInUp">
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{asset('assets1/img/team/team-1.jpg')}}" alt=""></div>
              <h4>Walter White</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{asset('assets1/img/team/team-2.jpg')}}" alt=""></div>
              <h4>Sarah Jhinson</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{asset('assets1/img/team/team-3.jpg')}}" alt=""></div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{asset('assets1/img/team/team-4.jpg')}}" alt=""></div>
              <h4>Amanda Jepson</h4>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="{{asset('assets1/img/gallery/gallery-1.jpg')}}" data-gall="portfolioGallery" class="venobox">
                <img src="{{asset('assets1/img/gallery/gallery-1.jpg')}}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="{{asset('assets1/img/gallery/gallery-2.jpg')}}" data-gall="portfolioGallery" class="venobox">
                <img src="{{asset('assets1/img/gallery/gallery-2.jpg')}}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="{{asset('assets1/img/gallery/gallery-3.jpg')}}" data-gall="portfolioGallery" class="venobox">
                <img src="{{asset('assets1/img/gallery/gallery-3.jpg')}}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="{{asset('assets1/img/gallery/gallery-4.jpg')}}" data-gall="portfolioGallery" class="venobox">
                <img src="{{asset('assets1/img/gallery/gallery-4.jpg')}}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="{{asset('assets1/img/gallery/gallery-5.jpg')}}" data-gall="portfolioGallery" class="venobox">
                <img src="{{asset('assets1/img/gallery/gallery-5.jpg')}}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="{{asset('assets1/img/gallery/gallery-6.jpg')}}" data-gall="portfolioGallery" class="venobox">
                <img src="{{asset('assets1/img/gallery/gallery-6.jpg')}}" alt="">
              </a>
            </div>
          </div>
  ...
  <script src="{{asset('assets1/vendor/superfish/superfish.min.js')}}"></script>
  <script src="{{asset('assets1/vendor/hoverIntent/hoverIntent.js')}}"></script>
